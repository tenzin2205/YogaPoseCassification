...
class ProcessData:
    ...
    def preprocess_single_data(self,X_train):
        ...
        embedding = self.landmarks_to_embedding(tf.reshape(tf.convert_to_tensor(X_train), (1, 51)))
    ...
    def preprocess_data(self,X_train):
        ...
        for i in range(X_train.shape[0]):
            embedding = self.landmarks_to_embedding(tf.reshape(tf.convert_to_tensor(X_train.iloc[i]), (1, 51)))
