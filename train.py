...
class Trainer(ProcessData):
    ...
    def train_others(self,classifier):
        ...
        if (classifier=="gbm"):
            ...
            knn_classifier = KNeighborsClassifier(algorithm="auto",n_neighbors=7,weights="distance")
            ...
            forest = RandomForestClassifier(random_state=42,max_depth=10,min_samples_split=2,n_estimators=50,verbose=True)
            # Perform grid search
